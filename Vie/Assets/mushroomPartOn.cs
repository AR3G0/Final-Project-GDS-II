...
public class mushroomPartOn : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        particleSystem3 = part3.GetComponent<ParticleSystem>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "lightCone")
        {
            ...
            if (slider.value > 50) main3.startColor = new Color(0, 0, 0, 1);
            else main3.startColor = new Color(1, 1, 1, 1);
